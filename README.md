...
This is my main Large Type Pieces (Unicode 16.0) font, containing 1308 characters covering ASCII, Latin-1, Latin Extended-A, Latin Extended Additional, some of Latin Extended-B, superscripts, subscripts, small capitals, number forms, Greek, Cyrillic, Japanese half-width Katakana, some mathematical operators and symbols, and more.
...
This font family is inspired by the look of ST+Roy/SAC Beyond, but using just 5 rows by taking advantage of Unicode 16.0 Symbols for Legacy Computing. It contains 1169 characters, and supports the ASCII, ISO 8859-1 and Windows 1252 Latin-1 characters sets, Greek, Cyrillic, Japanese Katakana (and Hiragana as Katakana), and more.
