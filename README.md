...
|[phm-shinonome](#phm-shinonome)| 3 | 10509 |✔︎|✔︎|✔︎|✔︎|✔︎|✔︎|✔︎|
...
- More Latin letters (Full Latin-1 Supplement, Latin Extended-A, Latin Extended-B, and IPA Extensions blocks)
- A growing set of emojis (564 so far)
- Additional symbols and pictographs

With 10509 characters, phm‑shinonome is probably the largest FIGlet font ever created, unifying historically incompatible Japanese and Western bitmap lineages into a single, terminal‑safe, Unicode‑coherent design.
