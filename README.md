...
|[phm-shinonome](#phm-shinonome)| 3 | 8870 |✔︎|✔︎|✔︎|✔︎|✔︎|✔︎|✔︎|
...
|[phm-beyondneo-*](#phm-beyond-neo-figfont-family)| 5 | 3243 |✔︎|✔︎|✔︎|✔︎|partial| |✔︎|
...
This might just make it the largest FIGlet font ever, as it contains a total of 8870 characters!
...
This font family is inspired by the look of ST+Roy/SAC Beyond, but using just 5 rows by taking advantage of Unicode 16.0 Symbols for Legacy Computing. It contains 3243 characters, and supports the ASCII, ISO 8859-1 and Windows 1252 Latin-1 characters sets, Greek, Cyrillic, Japanese Katakana (and Hiragana as Katakana), 133 ideographs (mostly for dates, times, places, and numbers in Chinese numerals), 325 color symbols and emojis, and more.
