...
|[phm-beyondneo-*](#phm-beyond-neo-figfont-family)| 5 | 3252 |✔︎|✔︎|✔︎|✔︎|partial| |✔︎|
...
It is also improved to reach parity with Lucida Console, making it compatible with western Windows console before Windows Vista.
It also contains symbols supported by MS Gothic / ＭＳ ゴシック from Windows 3.1 to Windows XP, making it mostly compatible with Japanese Windows console before Windows Vista.
Finally, it contains a growing number of Emojis (396 so far).
This might just make it the largest FIGlet font ever, as it currently contains a total of 10051 characters!
...
This font family is inspired by the look of ST+Roy/SAC Beyond, but using just 5 rows by taking advantage of Unicode 16.0 Symbols for Legacy Computing. It contains 3252 characters, and supports the ASCII, ISO 8859-1 and Windows 1252 Latin-1 characters sets, Greek, Cyrillic, Japanese Katakana (and Hiragana as Katakana), 138 ideographs (mostly for dates, times, places, and numbers in Chinese numerals), 329 color symbols and emojis, and more.
