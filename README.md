...
|[phm-beyondneo-*](#phm-beyond-neo-figfont-family)| 5 | 3956 |ISO 8859-1 + CP1252|Japanese Katakana + a few Kanji|CP437 + Some emojis|
...
It uses just 5 rows by taking advantage of Unicode 16.0 Symbols for Legacy Computing. It contains 3956 characters, and supports the ASCII, ISO 8859-1 and Windows 1252 Latin-1 character sets, Greek, Cyrillic, Japanese Katakana (and Hiragana as Katakana), 152 ideographs (mostly for dates, times, places, and numbers in Chinese numerals), 431 color symbols and emojis (all smiley faces and hands, and some pictographs and emojis), and more.
