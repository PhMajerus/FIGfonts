...
|[phm-shinonome](#phm-shinonome)| 3 | 14688 |ISO 8859-1 + All latin-based MS-DOS and Windows codepages|Japanese CP932 + Jōyō + Jinmeiyō + CP737 + CP869 + CP1253 (Greek) + CP855 + CP866 + CP1251 (Cyrillic)|CP437 + Emojis + more|
...
|[phm-beyondneo-*](#phm-beyond-neo-figfont-family)| 5 | 3582 |ISO 8859-1 + CP1252|Japanese Katakana + a few Kanji|CP437 + Some emojis|
...
With 14688 characters, phm‑shinonome is probably the largest FIGlet font ever created, unifying Japanese, Western, and semigraphic bitmap lineages into a single Unicode‑coherent design.
...
It uses just 5 rows by taking advantage of Unicode 16.0 Symbols for Legacy Computing. It contains 3582 characters, and supports the ASCII, ISO 8859-1 and Windows 1252 Latin-1 character sets, Greek, Cyrillic, Japanese Katakana (and Hiragana as Katakana), 150 ideographs (mostly for dates, times, places, and numbers in Chinese numerals), 335 color symbols and emojis, and more.
...
-- Philippe Majerus, October 2024 to June 2026
