...
This font family is inspired by the look of ST+Roy/SAC Beyond, but using just 5 rows by taking advantage of Unicode 16.0 Symbols for Legacy Computing. It contains 757 characters, and supports the ASCII, ISO 8859-1 and Windows 1252 Latin-1 characters sets, Japanese Katakana (and Hiragana as Katakana), and Cyrillic (MS-DOS 866).
