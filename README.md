...
|[phm-shinonome](#phm-shinonome)| 3 | 12024 |✔︎|✔︎|✔︎|✔︎|✔︎|✔︎|✔︎|
...
- Lucida Console parity, ensuring compatibility with Western Windows console (Windows NT4 → Vista)
- Most of Cascadia characters, improving compatibility with Windows Terminal (Windows 10 → 11)

**Modern additions**
- Braille, block mosaic patterns, block diagonals, large type pieces, and other Symbols for Legacy Computing
- More Latin letters (Full Latin-1 Supplement, Latin Extended-A, Latin Extended-B, IPA Extensions, Latin Extended Additional, and Latin Extended-C blocks)
- A growing set of emojis (783 so far)
- Additional symbols and pictographs

With 12024 characters, phm‑shinonome is probably the largest FIGlet font ever created, unifying Japanese, Western, and semigraphic bitmap lineages into a single Unicode‑coherent design.
