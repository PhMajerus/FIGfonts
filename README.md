...
It also contains many characters supported by MS Gothic from Windows 3.1 to Windows XP, making it mostly compatible with Japanese Windows console before Windows Vista.
