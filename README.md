...
I extended it to support the original IBM PC (MS-DOS codepage 437), DOS/V (codepage 932), and Windows Latin-1 (codepage 1252).

The characters are 6×12 pseudo-pixels for half-width and 12×12 pseudo-pixels for full-width, rendered as 3×3 and 6×3 octants characters respectively. It uses three rows and supports ISO 8859-1 and Windows codepage 1252 (Latin 1), MS-DOS codepage 437 (IBM PC/en-US), JIS X 0201 and JIS X 0208 (all 2965 level 1 kanji + 3390 level 2 kanji + 仝 = 6356 ideographs), which also contains basic Greek and Cyrillic, and NEC PC-98 and IBM DOS/V extensions (361 ideographs and more symbols, codepage 932).
This might just make it the largest FIGlet font ever, as it contains a total of 7699 characters!
