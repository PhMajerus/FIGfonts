...
It also uses Sextants and Octants for some non-alphabetical characters such as Braille, outlined letters, and 7-segment digits.
...
It contains 620 characters, and supports the ASCII, ISO 8859-1 and Windows 1252 Latin-1 characters sets, and Japanese Katakana (and Hiragana as Katakana).
...
This font family is inspired by the look of ST+Roy/SAC Beyond, but using just 5 rows by taking advantage of Unicode 16.0 Symbols for Legacy Computing. It contains 1382 characters, and supports the ASCII, ISO 8859-1 and Windows 1252 Latin-1 characters sets, Greek, Cyrillic, Japanese Katakana (and Hiragana as Katakana), 70 ideographs (mostly for dates, times, and numbers in Chinese numerals), and more.
