...
|[phm-shinonome](#phm-shinonome)| 3 | 11947 |✔︎|✔︎|✔︎|✔︎|✔︎|✔︎|✔︎|
...
- A growing set of emojis (775 so far)
- Additional symbols and pictographs

With 11947 characters, phm‑shinonome is probably the largest FIGlet font ever created, unifying Japanese, Western, and semigraphic bitmap lineages into a single Unicode‑coherent design.
