...
|[phm-shinonome](#phm-shinonome)| 3 | 11906 |✔︎|✔︎|✔︎|✔︎|✔︎|✔︎|✔︎|
...
- A growing set of emojis (734 so far)
- Additional symbols and pictographs

With 11906 characters, phm‑shinonome is probably the largest FIGlet font ever created, unifying Japanese, Western, and semigraphic bitmap lineages into a single Unicode‑coherent design.
